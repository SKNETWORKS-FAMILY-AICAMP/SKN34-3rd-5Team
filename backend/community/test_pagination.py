...
class CommunityPostPaginationTests(APITestCase):
    ...
    def test_page_boundaries_use_default_page_size(self):
        ...
        self.assertEqual((first.status_code, first.data["count"], len(first.data["results"])), (200, 351, 20))
        self.assertEqual((last.status_code, last.data["count"], len(last.data["results"])), (200, 351, 11))
