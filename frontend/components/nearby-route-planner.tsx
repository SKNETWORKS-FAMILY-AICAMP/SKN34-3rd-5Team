...
function LoadedPlanner({ maps, plannerMode = "places", stadium, stops, onChange: onStopsChange, initialStart, onStartChange, initialTravelMode, onTravelModeChange, courseName, onCourseNameChange, onSaveCourse, saving, saveError, startWithAllPlaces = false, onCompletionChange, autoComplete = false, onAutoCompleted, unlockRequest = "", guide = false }: PlannerProps & { maps: KakaoMaps }) {
